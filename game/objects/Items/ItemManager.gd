...
var POOLS := {
	"treasure": [
		...
		{"id": "shield", 	"scene": preload("uid://bpbfutvulj0wd"), 	"tier": 0},
	...
	"shop": [
		...
		{"id": "heal", 		"scene": preload("uid://baga6mxgrpf1s"), 	"tier": 1},
		{"id": "healalt", 	"scene": preload("uid://ujleakh3r3l0"), 		"tier": 1},
		{"id": "healblack", 	"scene": preload("uid://c83w3v5l3edwc"), 	"tier": 1},
		{"id": "healbig", 	"scene": preload("uid://bvy7i2nw65tyy"), 	"tier": 1},
		{"id": "shield", 	"scene": preload("uid://bpbfutvulj0wd"), 	"tier": 1},
